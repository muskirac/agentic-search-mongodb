...
### Documentation
- [Speaker Transcript](docs/speaker-transcript.md) - Full talk content on agentic AI
- [Live Demo Notes](docs/live-demo.md) - Technical details and architecture
- [Presentation Slides](https://docs.google.com/presentation/d/1WoMi_avJLsNZlTSFLc7Q_M39rZ-E4xqVgc41VgJwiMo)

### External Resources
- [MongoDB Atlas Documentation](https://www.mongodb.com/docs/atlas/)
- [MongoDB Atlas Search](https://www.mongodb.com/docs/atlas/atlas-search/)
- [Google Gemini API Documentation](https://ai.google.dev/docs)
- [Pydantic Documentation](https://docs.pydantic.dev/) (used for structured outputs)

## Development Notes

The codebase follows a clean separation inspired by biological systems (proteins → cells → organisms):

- **Brain ([agent.py](agent.py))**: Define structured outputs first, then system prompts, then the reasoning loop
- **Toolbox ([mongodb.py](mongodb.py))**: Specialized tools the agent can dynamically select
- **Controller ([app.py](app.py))**: Orchestrates the Sense → Plan → Act → Evaluate → Learn loop
- **Utilities ([utils.py](utils.py))**: Visualization and formatting helpers

All modules use type hints and Pydantic for validation, ensuring the agent's outputs are predictable and debuggable.
